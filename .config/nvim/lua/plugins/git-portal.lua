MiniDeps.later(function()
  ...
  vim.keymap.set("n", "<leader>gb", gitportal.open_file_in_browser)
  vim.keymap.set("v", "<leader>gb", gitportal.open_file_in_browser)

  -- Opens a Githost link directly in Neovim, optionally switching to the branch/commit.
  vim.keymap.set("n", "<leader>gl", gitportal.open_file_in_neovim)
